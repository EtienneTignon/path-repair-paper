...
\begin{itemize}
  ...
  \item For every vertex pseudo-conflict $(a_1,a_2,v)$ in $S$, we must add one of the following edge in $E_{C-vp}$:\comment{Add that the actions must be from those that already exist}
  \begin{itemize}
...
From this given \comment{TODO : getting the stroll}
